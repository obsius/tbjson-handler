...
export default class TbjsonHandler {
	...
	listen(nameOrArrayOrFilterFn, propertyNameOrArray, fn) {
		...
		let modelListeners = this[LISTENERS].models;
		let propListeners = this[LISTENERS].props;
		...
		if (nameOrArrayOrFilterFn == null) {
			...
			// property
				...
				// single property
					...
					return () => { delete propListeners[propertyNameOrArray][id]; };
				}
			}
		...
		// single
			...
			return () => { delete modelListeners[nameOrArrayOrFilterFn][id] };
